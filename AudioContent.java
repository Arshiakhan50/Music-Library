...
abstract public class AudioContent
{
  ...
  {
    System.out.println("Title: " + title + " Id: " + id + " Year: " + year + " Type: " + type + " Length: " + length);//the method that will be overwritten by the subclasses
  }
	
  // Play the content via the audio file
	public void play()
	{
		this.printInfo();//this means it belong to this object
	...
	{
		AudioContent otherCon = (AudioContent) other;//must be casted to use it
		return title.equals(otherCon.title) && id.equals(otherCon.id);//checkign if the paramers of this object and the one given are equal
